...
1) EDA and Data Re-organizing/Cleaning.
2) Determine which distribution each independent variable follows.
3) Model individual independent variables.
4) Determine how the dependent variables interact with each other.
5) Create and tune recursive stochastic model.
6) Create hypothetical models.
7) Run Monte Carlo Simulations on the models
8) Compile results and evidence into a Technical Report, Executive Summary, and Presentation.
